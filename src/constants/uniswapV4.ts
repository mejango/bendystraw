import { firstRolloutBlock } from "./rollout";
...
export const JB_UNISWAP_V4_POSITION_MANAGER = {
  ethereum: {
    ...
    startBlock: firstRolloutBlock("JBUniswapV4Hook", "ethereum"),
  },
  arbitrum: {
    address: "0xd88f38f930b7952f2db2432cb002e7abbf3dd869",
    startBlock: firstRolloutBlock("JBUniswapV4Hook", "arbitrum"),
  },
  base: {
    address: "0x7c5f5a4bbd8fd63184577525326123b519429bdc",
    startBlock: firstRolloutBlock("JBUniswapV4Hook", "base"),
  },
  optimism: {
    address: "0x3c3ea4b57a46241e54610e5f022e5c45859a1017",
    startBlock: firstRolloutBlock("JBUniswapV4Hook", "optimism"),
  },
  ethereumSepolia: {
    address: "0x429ba70129df741b2ca2a85bc3a2a3328e5c09b4",
    startBlock: firstRolloutBlock("JBUniswapV4Hook", "ethereumSepolia"),
  },
  arbitrumSepolia: {
    address: "0xac631556d3d4019c95769033b5e719dd77124bac",
    startBlock: firstRolloutBlock("JBUniswapV4Hook", "arbitrumSepolia"),
  },
  baseSepolia: {
    address: "0x4b2c77d209d3405f41a037ec6c77f7f5b8e2ca80",
    startBlock: firstRolloutBlock("JBUniswapV4Hook", "baseSepolia"),
  },
} as const;
